export const nutritionTab = [
  ...
  {
    fact__value: "aorganique",
    fact__label: "Acides organiques (g/100 g)",
  },
  {
    fact__value: "agsaturés",
